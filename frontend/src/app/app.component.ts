...
export class AppComponent {
	...
	constructor() {
		...
		this.queue.songs.push(new Song("Radar Maker", this.album, 1997, "https://p.scdn.co/mp3-preview/374337753e9b9024bed15d1cfea1a2763b210e28?cid=774b29d4f13844c495f206cafdad9c86", "", 0));
